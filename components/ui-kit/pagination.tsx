  ...
  return (
    <Button
      ...
      className={clsx(
        ...
        current && 'before:bg-content-interaction dark:before:bg-content-background/10'
      )}
    >
...
export function PaginationGap({
  ...
  return (
    <span
      aria-hidden="true"
      {...props}
      className={clsx(className, 'w-9 text-center text-sm/6 font-semibold text-content-foreground select-none ')}
    >
      {children}
    </span>
  )
