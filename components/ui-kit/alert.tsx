        ...
        <div className="grid min-h-full grid-rows-[1fr_auto_1fr] justify-items-center p-8 sm:grid-rows-[1fr_auto_3fr] sm:p-4">
          <Headless.DialogPanel
            ...
            className={clsx(
              className,
              sizes[size],
              'row-start-2 w-full rounded-2xl bg-content-background p-8 shadow-lg ring-1 ring-content-border sm:rounded-2xl sm:p-6   forced-colors:outline',
...
export function AlertTitle({
  ...
  return (
    <Headless.DialogTitle
      ...
      className={clsx(
        className,
        'text-center text-base/6 font-semibold text-balance text-content-foreground sm:text-left sm:text-sm/6 sm:text-wrap '
      )}
    />
  )
}
